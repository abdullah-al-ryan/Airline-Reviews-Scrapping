...
a_reviews = AppStore('us', 'fly-delta', '388491656')
a_reviews.review()
...
# Specify the file path for the Excel file on the desktop
excel_file_path = os.path.join(home_dir, "Desktop", "deltaAirlines.xlsx")
